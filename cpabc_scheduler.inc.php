...
-->
<form class="cpp_form" name="FormEdit" method="post" onsubmit='alert("Calling Appointment");return doValidate()'>
...
<script type="text/javascript">
 ...
 function doValidate(form)
 {
    ...
    // Jai - Need to get the remaining available classes/slots for this student and then use it
    ...
    form.submit('<?php cpabc_process_ready_to_go_appointment(1, "jaikumar_govindan@yahoo.com"); ?>');
    alert('i am back');
 }
</script>
<br />
