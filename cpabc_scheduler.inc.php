<?php if (!defined('CPABC_AUTH_INCLUDE')) {
...
-->
<form class="cpp_form" name="FormEdit" method="post"
      onsubmit=''>
    ...
    <div <?php if (count($myrows) < 2) echo 'style="display:none"'; ?>>
        ...
        <select name="cpabc_item" id="cpabc_item"
                onchange="cpabc_updateItem()"><?php echo $calendar_items; ?></select><br/><br/>
    </div>
    <?php
